...
{
    public class PerformanceParameter : BaseObject
    {
        public PerformanceParameter(Session session)
            : base(session)
        {
        }
        ...
        private PerformanceParameterGroup _mGroup;
        [Association("PerformanceParameterGroup-PerformanceParameters")]
        public PerformanceParameterGroup Group
        {
            get { return _mGroup; }
