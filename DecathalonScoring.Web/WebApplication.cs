...
namespace DecathalonScoring.Web {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class DecathalonScoringAspNetApplication : WebApplication {
        ...
        static DecathalonScoringAspNetApplication() {
        ...
        #endregion
        public DecathalonScoringAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void DecathalonScoringAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            // 
            this.ApplicationName = "DecathalonScoring";
